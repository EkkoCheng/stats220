...
- I am taking STATS 220 because I want to improve my data skills.
- I am interested in learning about data visualisation and web-based data.
## My goals for this course

1. Improve my Markdown skills
2. Learn how to use R and RStudio
3. Create web-based content
